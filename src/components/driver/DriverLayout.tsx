...
export const DriverLayout: React.FC<DriverLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    { to: '/driver', icon: <LayoutDashboard className="w-5 h-5" />, label: t.overview },
    { to: '/driver/orders', icon: <Package className="w-5 h-5" />, label: t.availableOrders, badge: 3 },
    { to: '/driver/active', icon: <CheckCircle className="w-5 h-5" />, label: t.activeOrder },
    { to: '/driver/tracking', icon: <MapPin className="w-5 h-5" />, label: t.tracking },
    { to: '/driver/ratings', icon: <Star className="w-5 h-5" />, label: t.ratings },
  ];
          ...
          <div className="p-6 border-b">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{t.driverDashboard}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-t">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-sm text-foreground truncate">أحمد محمد</p>
